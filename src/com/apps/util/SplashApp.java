 ...
 * your {@code SplashApp} implementation class, call {@link #welcome(String...)}, and then {@link #start()}.
 * </p>
 *
 * <p>
 ...
 * </p>
 * <code>$ java -splash:images/snowman.png com.games.snowman.SnowmanApp</code>
 *
 * <pre>
 * <code>
 *     package com.games.snowman;
 *
 *     import com.apps.util.SplashApp;
 *
 *     class SnowmanApp <b>implements SplashApp</b> {
 *
 *         // @Override
 *         public void start() {
 *             Game game = new Game();
 ...
 *             app.welcome("images/credits.jpg", "images/java.png");
 *             app.start();
 *         }
 *     }
 * </code>
...
public interface SplashApp {
    public static final long DEFAULT_PAUSE = 3000;
     ...
     * If you only want the initial image shown (see {@code -splash} above), simply call {@code welcome()}
     * with no {@code imagesFiles} arguments.
     ...
     */
    default public void welcome(String... imageFiles) throws IllegalArgumentException {
     ...
     * splash image is specified incorrectly on the command line (see {@code -splash} above).
     */
    default public void welcome(long pause, String... imageFiles) throws IllegalArgumentException {
