...
public class TicketConfirmation extends javax.swing.JFrame {
     ...
     */
    public TicketConfirmation(String name, String flightdate, String depttime,
                              String deptFrom, String destination, String arrivaltime,
                              String flight, String duration, String seat,
        ...
        jButton1 = new javax.swing.JButton();
         ...
         flightDate.setText(flightdate);
         flightDuration.setText(duration);
         flightID.setText(flight);
         fullName.setText(name);
         originCity.setText(deptFrom);
    ...
    private void initComponents() {
        ...
        fullName.setToolTipText("Passenger's Name");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicketConfirmation("Chris Lee", "July 15 2021", "10:00 am",
                        "Miami", "New York", "2:00 pm",
                        "AA288", "4 hours", "C38",
                        "175.98", "XXXX-XXXX-XXXX-2948").setVisible(true);
            }
        });
    }
