...
public class TicketWindow extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        System.out.println("You would like to fly from: " +
                (String) jComboBox3.getSelectedItem() + " to "
                + (String) jComboBox2.getSelectedItem() + " on "
    ...
    public void fromSearchFlightWindowToSelectFlightWindow() {
...
/*        jButton1.addActionListener(e ->System.out.println("You would like to fly from: " +
                (String) jComboBox3.getSelectedItem() + " to "
                + (String) jComboBox2.getSelectedItem() + " on "
                + jFormattedTextField1.getText()));*/
